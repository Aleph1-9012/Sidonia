...
- `f/sidonia-t1-1440p-upper.pf2`
- `f/sidonia-t1-1440p-lower.pf2`
- `selectors/*.png`
- `progress/*.png`

Load `fonts/sidonia-t1-1440p.pf2` through the distribution's `GRUB_FONT` mechanism before selecting `theme.txt`. GRUB's standard theme loader loads the two role-specific PF2 files under `f/`. Production menu titles remain dynamic and come from the existing GRUB configuration.
