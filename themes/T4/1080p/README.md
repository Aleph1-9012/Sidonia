# Sidonia T4 — Maintenance Console (1080p)
...
Transparent style padding confines GRUB's mandatory 200×28 progress-widget allocation to the intended 68×7 header line. The progress widget intentionally has no `text` property because an empty template still makes GRUB reserve font space.
